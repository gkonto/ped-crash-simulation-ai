...
if __name__=="__main__":
    ...
    time_points = list(range(len(entry['Head_Z_Coordinate'])))
    plt.figure(figsize=(12, 6))

    plt.plot(time_points, entry['Head_X_Coordinate'], label='X Coordinate')
    plt.plot(time_points, entry['Head_Y_Coordinate'], label='Y Coordinate')
    plt.plot(time_points, entry['Head_Z_Coordinate'], label='Z Coordinate')
